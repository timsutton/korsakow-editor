...
public class DeleteSoundCommand extends AbstractCommand{


	public DeleteSoundCommand(Helper request, Helper response) {
	...
	public void execute()
		...
		try {
			Sound v = null;
			v = SoundInputMapper.map(request.getLong(UpdateSoundCommand.ID));
