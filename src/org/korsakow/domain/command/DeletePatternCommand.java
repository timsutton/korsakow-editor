...
public class DeletePatternCommand extends AbstractCommand{


	public DeletePatternCommand(Helper request, Helper response) {
	...
	public void execute()
		...
		try {
			Pattern v = null;
			v = PatternInputMapper.map(request.getLong("id"));
