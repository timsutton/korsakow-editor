...
public class PredicateTDG
{
	public static final String NODE_NAME = "Predicate";
	...
	public static int insert(long object_id, long id, long version, String type) throws XPathExpressionException{
		Element tableElement = createPredicateTable(object_id);
	...
	public static int deleteByResource(long resource_id) throws XPathExpressionException {
		...
		if (objectElement == null)
			return 0;
		Element tableElement = DomUtil.findChildByTagName(objectElement, "predicates");
	...
	public static Element createPredicateTable(long object_id) throws XPathExpressionException {
		Element objectElement = DataRegistry.getHelper().findElementByIdTag(object_id);
		Element tableElement = DomUtil.findChildByTagName(objectElement, "predicates");
		if (tableElement == null) {
			tableElement = DataRegistry.getHelper().appendUniqueElement(objectElement, "predicates");
		}
		return tableElement;
	}
