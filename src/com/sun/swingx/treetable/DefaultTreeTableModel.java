/*
 * $Id: DefaultTreeTableModel.java,v 1.15 2008/12/03 19:27:52 kschaefe Exp $
 *
 ...
 */
package com.sun.swingx.treetable;
...
public class DefaultTreeTableModel extends AbstractTreeTableModel {
    ...
    public boolean isValidTreeTableNode(Object node) {
    ...
    public void setColumnIdentifiers(List<?> columnIdentifiers)
    {
        ...
        useAutoCalculatedIdentifiers = false;

        if (columnIdentifiers == null) {
        	columnIdentifiers = new ArrayList();
        	((ArrayList)columnIdentifiers).add("A");
        }
...
//        modelSupport.fireNewRoot();
    ...
    public void addColumnIdentifier(Object identifier)
    {
    	((ArrayList<Object>)columnIdentifiers).add(identifier);
    }
    public void setColumnIdentifier(Object identifier, int column)
    {
    	((ArrayList<Object>)columnIdentifiers).set(column, identifier);
    }
    ...
    public void addColumn(Object identifier)
    {
    	useAutoCalculatedIdentifiers = false;
    	if (columnIdentifiers == null)
    		columnIdentifiers = new ArrayList<Object>();
    	((ArrayList<Object>)columnIdentifiers).add(identifier);
    	fireTreeStructureChanged(this, getPathToRoot(getRoot()), new int[0], new Object[0]);
    }
    ...
    public Object getValueAt(Object node, int column) {
        if (!isValidTreeTableNode(node)) {
            throw new IllegalArgumentException(
                    "node must be a valid node managed by this model: col=" + column + "; " + node);
        }

        if (column < 0 || column >= getColumnCount()) {
            throw new IllegalArgumentException("column must be a valid index: " + column);
        }
    ...
    public void insertNodeInto(MutableTreeTableNode newChild,
	    ...
	    fireTreeNodesInserted(this, getPathToRoot(parent),
				 new int[] { getIndexOfChild(parent, newChild) },
				 new Object[] { newChild });
    }
