...
public class PercentConfig implements ArgConfig
{
	private boolean isEditable;
	private String label;
	private ListCellRenderer renderer;
	private Collection<Double> choices;
	public PercentConfig(double min, double max, int steps, boolean isEditable, String label)
	{
		this(min, max, steps, isEditable, label, new DefaultListCellRenderer());
	}
	public PercentConfig(double min, double max, int steps, boolean isEditable, String label, ListCellRenderer renderer)
	{
		this.label = label;
	...
	public ListCellRenderer getRenderer(EventEditor editor) {
		return new PercentListCellRenderer();
	}
}
