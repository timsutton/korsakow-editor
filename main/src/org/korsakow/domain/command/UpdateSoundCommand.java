...
public class UpdateSoundCommand extends AbstractCommand{
	...
	public UpdateSoundCommand(Helper request, Helper response) {
	...
	public void execute()
		...
		try {
			Sound v = null;
			v = SoundInputMapper.map(request.getLong(ID));
