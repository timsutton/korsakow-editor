...
//		}
	...
	{
		debugPrintln( "NanoHTTPD 1.11 (C) 2001,2005-2008 Jarno Elonen\n" +
		...
		debugPrintln( "Now serving files in port " + port + " from \"" +
							new File("").getAbsolutePath() + "\"" );
		debugPrintln( "Hit Enter to stop.\n" );
